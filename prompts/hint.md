...
If a matching track is available, ground the hint in `track.md`, `roadmap.md`, and `progress.md`.
...
If I report a meaningful completion, reflection, or blocker, update `progress.md` before replying.
